...
```
docker exec -it kafka kafka-console-consumer --bootstrap-server localhost:9092 --topic redis-server
```
...
![Empty Graph](Desktop/Evaluate Human Balance with Spark Streaming/images/empty_graph.png)
...
![Toggle Switch](Desktop/Evaluate Human Balance with Spark Streaming/images/toggle_simulation.png)
...
![Populated Graph](Desktop/Evaluate Human Balance with Spark Streaming/images/populated_graph.png)
