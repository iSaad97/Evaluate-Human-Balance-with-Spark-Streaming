...
zSetDecodedEntriesStreamingDF = \
    zSetEntriesEncodedStreamingDF\
        .withColumn("customer", unbase64(zSetEntriesEncodedStreamingDF.customer)\
                    .cast("string"))
# +--------------------+
# |            customer|
# +--------------------+
...
emailAndBirthDayStreamingDF = emailAndBirthDayStreamingDF\
    .withColumn("birthYear", split("CustomerRecords.birthDay", "-")\
...
customerRiskStreamingDF = emailAndBirthYearStreamingDF\
